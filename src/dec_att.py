...
def create_model(model_input, pretrained_embedding, maxlen=30, embeddings='glove', sent_embed='univ_sent',
    ...
    q1_elmo = Lambda(model_utils.ElmoEmbedding, output_shape=(1024, ))(model_input[2])
    q2_elmo = Lambda(model_utils.ElmoEmbedding, output_shape=(1024, ))(model_input[3])
    ...
    if sent_embed == 'univ_sent':
        ...
        merged = Concatenate()([q1_rep, q2_rep, q1_elmo, q2_elmo])
